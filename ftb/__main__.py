...
from ftb.modules import ALL_MODULES
from ftb.modules.sudoers import bot_sys_stats
from ftb.utils import paginate_modules
from ftb.utils.constants import MARKDOWN
from ftb.utils.dbfunctions import clean_restart_stage
...
async def sttart_bot():
    ...
    for module in ALL_MODULES:
        imported_module = importlib.import_module("ftb.modules." + module)
...
home_keyboard_pm = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="Commands 👮‍♂️", callback_data="bbot_commands"),
